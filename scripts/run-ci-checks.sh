...
ansible-playbook \
  -i inventory/hosts.yml \
  playbooks/srv01-patch-reboot-negative-validation-suite.yml \
  --syntax-check \
  --ask-vault-password
...
ansible-playbook \
  -i inventory/hosts.yml \
  playbooks/srv01-admin-group-negative-validation-suite.yml \
  --syntax-check \
  --ask-vault-password

ansible-playbook \
  -i inventory/hosts.yml \
  playbooks/srv01-account-state-negative-validation-suite.yml \
  --syntax-check \
  --ask-vault-password

ansible-playbook \
  -i inventory/hosts.yml \
  playbooks/srv01-user-rights-negative-validation-suite.yml \
  --syntax-check \
  --ask-vault-password

ansible-playbook \
  -i inventory/hosts.yml \
  playbooks/srv01-audit-policy-negative-validation-suite.yml \
  --syntax-check \
  --ask-vault-password
